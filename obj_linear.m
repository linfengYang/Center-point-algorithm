...
new_model.SR_Aineq=[model.SR_Aineq,sparse(size(model.SR_Aineq,1),secondary_vari_num)];
new_model.SR_bineq=model.SR_bineq;
new_model.minOnorOff_Aineq=[model.minOnorOff_Aineq,sparse(size(model.minOnorOff_Aineq,1),secondary_vari_num)];
